...
## Block Diagram
![block-diagram](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/fig/block-diagram.png)
## Electronic Circuit
![design](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/fig/Design.png)
## Programming Scripts
- **ESP32 Code:**
[Arduino Code for ESP32](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/ECU_SDLOG_HTTP.ino)
- **HTML file for ESP32 Webserver**
[ESP32 Webserver HTML](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/index.html)
- **Node-Red Code:**
[Node Red Flows File](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/flows.json)
- **CSV Decrypt Code:**
[Decrypt string HEX to String](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/decryptCSV.py)
- **Plot Graph Code:**
[Plot graph from CSV data](https://github.com/syedmohiuddinzia/datalogger_ecu_mg6000/blob/main/v2.0/CSV_read.py)
